unit sysupdate.services.autoupdate;
...
begin
  ...
  try
    ...
    On E:Exception do
    begin
      ShowMessage('Falha na conexão com o servidor: ' + E.Message);
      Result := False;
    end;
  end;
end;
...
begin
  ...
  try
    ...
    FNomeApp := oArquivoINI.ReadString(VERSION, APPNAME, EmptyStr);
...
begin
  try
    ...
    FTamanhoExe := FidFTP.Size(FPathServer + 'update.zip');

    FidFTP.Get(FPathServer + '/update.zip',
